...
$sqlorders = "SELECT o.id, o.order_number, o.ean, o.anzahl , o.sale_price, o.sum_total,o.username,o.email, o.datetime, s.name FROM orders o, sortiment s WHERE s.ean = o.ean ORDER BY datetime DESC ";//sagen der Datenbank was wir sagen wollen
...
echo "<thead><tr><th>Order-ID</th><th>Order-Number</th><th>EAN</th><th>Game</th></th><th>Anzahl</th><th>Username</th><th>Verkaufspreis</th><th>Gesamtpreis</th><th>Bestelldatum</th></thead>";
