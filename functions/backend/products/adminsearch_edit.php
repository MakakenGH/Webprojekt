...
echo "<button type='button' class=\"form-control button_orange\" ><a href='?page=products&editmode=false2'><i class='fa fa-wrench'></i>  Bearbeitungsmodus deaktivieren</a></button><br>";
echo "</main>";
