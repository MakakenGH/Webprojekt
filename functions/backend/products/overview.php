...
echo "<a style='text-decoration: none;' href='?page=products&editmode=overview'><button type='button' class='form-control button_orange'><i class='fa fa-wrench'></i>  Bearbeitungsmodus aktivieren</button></a><br>";
echo "</main>";
